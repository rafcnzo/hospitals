            ...
            <div class="row gx-lg-5 align-items-center">
                <div class="col-lg-6 mb-5 mb-lg-0 hero-text" style="z-index: 10">
                    ...
                    <p class="mb-4 opacity-70" style="color: hsl(218, 81%, 85%)">
                        Silakan daftar untuk membuat akun baru di Ratatouille Hospital.
                    </p>
                </div>
                ...
                <div class="col-lg-6 mb-5 mb-lg-0 position-relative">
                    ...
                    <div class="card bg-glass login-card position-relative">
                        <div class="card-body px-4 py-5 px-md-5">
                            @if ($errors->any())
                                <div class="alert alert-danger mb-4">
                                    <div class="fw-bold">Gagal Register!</div>
                                    <ul class="mb-0">
                            ...
                            <form method="POST" action="{{ route('register') }}" id="registerForm">
                                ...
                                <button type="submit" class="btn btn-primary w-100 w-sm-auto" id="registerBtn">
                                    Register
                                </button>
                            </form>
                        </div>
                        ...
                        <!-- Loading Overlay -->
                        <div class="login-loading-overlay" id="registerLoadingOverlay">
                            <div class="login-loading-content">
                                <div class="spinner-pulse"></div>
                                <p class="login-loading-text">Memproses registrasi...</p>
                            </div>
                        </div>
                    </div>
                </div>
